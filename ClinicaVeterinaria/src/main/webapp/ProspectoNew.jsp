...
<body>
<div id="appDoctorNew">
  <form id="form1" name="form1" method="post" action="ProspectoRegistrarServlet">
    <table width="100%" border="1">
      <tr bgcolor="#D1F09D">
        <td colspan="6" bgcolor="#D1F09D"><div align="center"><strong>PROSPECTO</strong><strong> : NUEVO REGISTRO</strong></div></td>
      </tr>
      <tr>
        ...
        <td width="27%" bgcolor="#D6E9DE"><label>
          <input type="text" name="nombre" id="nombre" size="40" onKeypress="sololetras(this);"/>
        </label></td>
      ...
      <tr>
        ...
        <td bgcolor="#D1F09D"><span class="Estilo5">:</span></td>
        <td bgcolor="#D6E9DE"><label>
          <input type="text" name="telefono" id="telefono" maxlength="7" onkeyUp="return ValNumero(this);" onchange="0"/>
        </label></td>
      </tr>
      <tr>
        ...
        <td bgcolor="#D1F09D"><span class="Estilo5">:</span></td>
        <td bgcolor="#D6E9DE"><label>
          <input type="text" name="celular" id="celular" maxlength="8" onkeyUp="return ValNumero(this);" onchange="0"/>
        </label></td>
