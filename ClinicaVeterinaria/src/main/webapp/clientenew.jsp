...
<body>
<div id="appDoctorNew">
  <form id="form1" name="form1" method="post" action="ClientServlet">
    <table width="100%" border="1">
      <tr bgcolor="#D1F09D">
        <td colspan="6" bgcolor="#D1F09D"><div align="center"><strong>CLIENTE</strong><strong> : NUEVO REGISTRO</strong></div></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td bgcolor="#D1F09D"><span class="Estilo5">:</span></td>
        <td bgcolor="#D6E9DE"><label>
          <input type="text" name="celular" id="celular" maxlength="9" onkeyUp="return ValNumero(this);" onchange="0"/>
        </label></td>
