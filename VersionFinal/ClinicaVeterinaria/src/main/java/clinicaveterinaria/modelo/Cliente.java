...
public class Cliente {
	...
	// Un Cliente tiene varios Mascotas
	private Collection<Paciente> oPacientes;
	...
	public Collection<Paciente> getoPacientes() {
		return oPacientes;
	}

	public void setoPacientes(Collection<Paciente> oPacientes) {
	...
	public Cliente(Integer idCliente, String nombre, String email,
			...
			String notas, Integer idProspecto, Collection<Paciente> oPacientes) {
		super();
		this.idCliente = idCliente;
		this.nombre = nombre;
		this.email = email;
